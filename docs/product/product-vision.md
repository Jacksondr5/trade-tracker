...
2. monitoring and validating that thesis
3. turning it into trade plans
4. executing trades against those plans
5. reviewing the full decision chain afterward
...
- discipline as a long-term effect of repeated use
...
- loses track of why a trade was entered
- forgets the conditions for adding, trimming, or exiting
- cannot tell whether changing macro conditions are weakening a thesis
...
- TradingView shows price action and charts
- Trade Tracker governs the thinking, planning, note-taking, review, and analytics around those trades

This app should be a process system, not an execution terminal.

## Product Boundaries

Trade Tracker should not become:

- a broker terminal
- a charting replacement
- a live alerting system
- a live market monitoring system
- a general personal finance tracker
...
- better thesis formation
- clearer trade plans
- stronger note-taking during trades
- more honest retrospectives
- analytics that reveal whether the process is actually improving performance

The product should not prioritize features simply because they are common in trading software if they do not directly help improve process quality.
